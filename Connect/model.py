...
class Decoder(nn.Module):
    ...
    def __init__(self,decoder_dim, condition_dim=256, encoder_size=4096,encoder_dim=1, position_dim=128, attention_dim=128 , dropout=0.5):
        """
        :param encoder_dim: feature size of encoded images
        :param decoder_dim: size of decoder's RNN
        """
    ...
    def forward(self, encoder_out, enter, esc, sequence, sequence_inv, seq_len, teacher_ratio):
        """
        Forward propagation.
        ...
        preds, preds_inv = sequence[:,0,:],sequence_inv[:,0,:]
        ...
        for t in range(sequence.shape[1]):
            ...
            use_teacher_forcing = decision <= teacher_ratio
